...
\draw[->, dashed] ($(head.east)+(0, -0.1)$) -- ($(head.east) + (1.5, -0.1)$) {}
node[very near end, sloped, below] {\fcode{steal}};
\draw[->] ($(head.east) + (1.5, 0.1)$) --($(head.east) + (0, 0.1)$){} node[very
near start, sloped, above]{\fcode{push\_front}};
